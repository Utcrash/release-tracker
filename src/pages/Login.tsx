...
// const GOOGLE_CLIENT_ID = process.env.REACT_APP_GOOGLE_CLIENT_ID || '188480407734-83lsqgq61mdo6pf5h805dld5v9tipnih.apps.googleusercontent.com';
...
const Login: React.FC = () => {
  ...
  //   setError(null);
  //   try {
  //     const res = await fetch('/release-tracker/api/auth/google', {
  //       method: 'POST',
        ...
        >
          ...
          >
            <div style={{ background: '#23283a', padding: 40, borderRadius: 16, boxShadow: '0 2px 16px rgba(0,0,0,0.2)', width: '100%', maxWidth: 400 }}>
              <h2 style={{ color: '#fff', textAlign: 'center', marginBottom: 24, fontWeight: 600 }}>Login Disabled</h2>
              <p style={{ color: '#b0b8d1', textAlign: 'center' }}>
                Login functionality has been temporarily disabled.
              </p>
              <button 
